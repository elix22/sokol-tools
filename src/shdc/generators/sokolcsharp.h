...
class SokolCSharpGenerator: public Generator {
...
protected:
    ...
    void print2dArray(std::string name,std::string type,int rows,int columns);
    void print1dArray(std::string name,std::string type,int size);
private:
